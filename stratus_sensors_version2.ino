...
void writeSensorReadings(long lat, long lon, long alt, float uva, float uvb, float uvIndex, float tempC,
  ...
  if (myFile) {
    ...
    myFile.print(lat, 3); myFile.print(" "); myFile.print(lon, 3); myFile.print(" "); myFile.print(alt, 3); myFile.print(" ");
    myFile.print(uva, 3); myFile.print(" "); myFile.print(uvb, 3); myFile.print(" "); myFile.print(uvIndex, 3); myFile.print(" ");
    myFile.print(tempC, 3); myFile.print(" "); myFile.print(pressurePa, 3); myFile.print(" "); myFile.print(accelX, 3); myFile.print(" ");
    myFile.print(accelY, 3); myFile.print(" "); myFile.print(accelZ, 3); myFile.print(" "); myFile.print(gyroX); myFile.print(" ");
    myFile.print(gyroY, 3); myFile.print(" "); myFile.println(gyroZ, 3);
    // close the file:
    myFile.close();
    Serial.println("done.");
  } else {
